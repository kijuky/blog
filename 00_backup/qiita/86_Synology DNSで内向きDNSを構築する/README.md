...
![スクリーンショット 2026-02-25 15.05.12.png](./img/01.png)

ドメイン名に先ほど決めたゾーン名を、プライマリDNSサーバーにはルーター(DHCPサーバー)のIPアドレスを設定します。

![スクリーンショット 2026-02-25 15.07.56.png](./img/02.png)
...
![スクリーンショット 2026-02-25 15.24.13.png](./img/06.png)
...
![スクリーンショット 2026-02-25 15.26.48.png](./img/07.png)
